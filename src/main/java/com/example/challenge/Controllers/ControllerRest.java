...
class ControllerRest {
	...
	private static final Logger LOG = LogManager.getLogger(ControllerRest.class);

	
    private static final long TIME_WINDOW = 60 * 60 * 1000; // 60 minutes in milliseconds
    private final Set<Long> knownLineIds = Set.of(10L, 20L, 30L, 40L, 50L, 60l, 70L); // Example line IDs
